...
-   Call a Query or apply a Transaction [Query and Transaction section](/connector/latest/query-transaction)
-   Learn how to handle the different events associated to Queries and Transactions in the [Events section](/connector/latest/event)
