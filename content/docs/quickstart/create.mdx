...
<Tabs groupId="language" items={['AssemblyScript', 'Rust']}>
    ...
    <Tab value="Rust">
        For scaffolding a Rust applications on Klave you just need to fork the [rust-template](https://github.com/klave-network/rust-template/fork) repository and start from there.
    </Tab>
</Tabs>
...
<Tabs groupId="language" items={['AssemblyScript', 'Rust']}>
    ...
    <Tab value="Rust">
        - Use the command : `cargo component build --target wasm32-unknown-unknown --release`
