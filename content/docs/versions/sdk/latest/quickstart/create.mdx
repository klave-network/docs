...
<Steps>
	<Step>### Prerequisites: Check you have Node installed (node >=v20) ```bash copy node -v v20.9.0 ```</Step>
	<Step>
		...
		<Tabs items={['npm', 'npx', 'yarn']}>
			...
			<Tab value="npx">```bash copy npx create on-klave ```</Tab>
			<Tab value="yarn">```bash copy yarn create on-klave ```</Tab>
		</Tabs>
	</Step>
	<Step>
		### Follow-up instructions ```ansi [0m [0;32m✓[42;1;39;0m What is the npm package name? [0;32m... [0m [0;32m✓[42;1;39;0m What is the name of your trustless
		application? [0;32m... [0m [0;32m✓[42;1;39;0m How would you describe the trustless application? [0;32m... [0m [0;32m✓[42;1;39;0m What is the name of the author? [0;32m...
		[0m [0;32m✓[42;1;39;0m What is the email address of the author? [0;32m... [0m [0;32m✓[42;1;39;0m What is the URL to the author's GitHub profile? [0;32m... [0m [0;32m✓[42;1;39;0m What
		is the URL for the repository? [0;32m... ```
	</Step>
	<Step>### Move to the application directory and get your code ready</Step>
</Steps>
...
<Steps>
    ...
    <Tabs items={['Github CLI', 'Git']}>
        <Tab value="Github CLI">
            ```bash copy gh repo create git add . git commit -m "your commit message" git push --set-upstream origin master
            ```
        </Tab>
        <Tab value="Git">
            First create a new repo on your GitHub. ```bash copy git remote add origin git@github.com:username/your-repo.git
            git branch -m main git branch --set-upstream-to=origin/main main git add . git commit -m "your commit message"
            git push ```
        </Tab>
    </Tabs>
    </Step>
