...
<Tabs groupId="language" items={['AssemblyScript', 'Rust']}>
    ...
    <Tab value="Rust">
        ...
        fn subtle_crypto_rsa(input: String) {
            ...
            let key_usages_slice: Vec<&str> = vec!["encrypt", "decrypt", "sign", "verify"];
            let gen_algorithm: subtle::GenAlgorithm = rsa_params.into();
            let crypto_key: CryptoKey = match subtle::generate_key(&gen_algorithm, true, &key_usages_slice) {
                Ok(result) => result,
                Err(err) => {
                    klave::notifier::notify(&err.to_string());
                    return;
                }
            };
        }
...
<Tabs groupId="language" items={['AssemblyScript', 'Rust']}>
    ...
    <Tab value="Rust">
        ...
        fn subtle_crypto_ec(input: String) {
            ...
            let gen_algorithm: subtle::GenAlgorithm = ec_params.into();
            let crypto_key: CryptoKey = match subtle::generate_key(&gen_algorithm, true, &key_usages_slice) {
                Ok(result) => result,
                Err(err) => {
                    klave::notifier::notify(&err.to_string());
...
<Tabs groupId="language" items={['AssemblyScript', 'Rust']}>
    ...
    <Tab value="Rust">
        ...
        fn subtle_crypto_aes(input: String) {
            ...
            let gen_algorithm: subtle::GenAlgorithm = aes_params.into();
            let crypto_key: CryptoKey = match subtle::generate_key(&gen_algorithm, true, &key_usages_slice) {
                Ok(result) => result,
                Err(err) => {
                    klave::notifier::notify(&err.to_string());
...
<Tabs groupId="language" items={['AssemblyScript', 'Rust']}>
    ...
    <Tab value="Rust">
        ...
        fn subtle_crypto_aes_gcm(input: String) {
            ...
            let crypt_algorithm: subtle::EncryptAlgorithm = aes_params.into();
...
<Tabs groupId="language" items={['AssemblyScript', 'Rust']}>
    ...
    <Tab value="Rust">
        ...
        fn subtle_crypto_rsa_oaep(input: String) {
            ...
            let crypt_algorithm: subtle::EncryptAlgorithm = rsa_oaep_params.into();
            let encrypted_text = match subtle::encrypt(&crypt_algorithm, &crypto_key, &String::from("Hello World").into_bytes()) {
                Ok(result) => result,
                Err(err) => {
                    klave::notifier::notify(&err.to_string());
...
<Tabs groupId="language" items={['AssemblyScript', 'Rust']}>
    ...
    <Tab value="Rust">
        ...
        fn subtle_crypto_ecdsa(input: String) {
            ...
            let sign_algorithm: subtle::SignAlgorithm = sign_ec_params.into();
            ...
            if verify_result.is_valid() {
                klave::notifier::notify("Verified");
            }
            else {
                klave::notifier::notify("Not Verified");
            }
        }
        ```
    </Tab>
...
<Tabs groupId="language" items={['AssemblyScript', 'Rust']}>
    ...
    <Tab value="Rust">
        ...
        fn subtle_crypto_rsa_pss(input: String) {
            ...
            let sign_algorithm: subtle::SignAlgorithm = sign_rsa_params.into();
            let signature = match subtle::sign(&sign_algorithm, &crypto_key, &String::from("Hello World").into_bytes()) {
                Ok(result) => result,
                Err(err) => {
                    klave::notifier::notify(&err.to_string());
...
<Tabs groupId="language" items={['AssemblyScript', 'Rust']}>
    ...
    <Tab value="Rust">
        ...
        fn subtle_crypto_aes_kw(input: String) {
            ...
            let gen_algorithm_wrap_key: subtle::GenAlgorithm = aes_params_wrap_key.into();
            ...
            // Wrap
            let wrapped_key = match subtle::wrap_key(&"raw", &crypto_key, &wrapping_key, &subtle::NamedAlgorithm { name: "AES-KW".to_string() }.into()) {
                Ok(result) => result,
                Err(err) => {
                    klave::notifier::notify(&err.to_string());
                    return;
            ...
            let unwrapped_key = match subtle::unwrap_key(&"raw", &wrapped_key, &wrapping_key, 
                &subtle::NamedAlgorithm { name: "AES-KW".to_string() }.into(), 
...
<Tabs groupId="language" items={['AssemblyScript', 'Rust']}>
    ...
    <Tab value="Rust">
        ...
        fn subtle_crypto_aes_gcm_wrap(input: String) {
            ...
            let wrapping_algorithm: subtle::WrapAlgorithm = aes_params.into();
...
<Tabs groupId="language" items={['AssemblyScript', 'Rust']}>
    ...
    <Tab value="Rust">
        ...
        fn subtle_crypto_rsa_oaep_wrap(input: String) {
            ...
            let key_usages_wrap_key: Vec<&str> = vec!["wrap_key", "unwrap_key"];
            let gen_algorithm_wrap_key: subtle::GenAlgorithm = rsa_params_wrap_key.into();
            let wrapping_key: CryptoKey = match subtle::generate_key(&gen_algorithm_wrap_key, true, &key_usages_wrap_key) {
                Ok(result) => result,
                Err(err) => {
                    klave::notifier::notify(&err.to_string());
            ...
            let rsa_oaep_params = subtle::RsaOaepParams { label: vec![] };
            let wrapping_algorithm: subtle::WrapAlgorithm = rsa_oaep_params.into();
