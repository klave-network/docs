...
The cornerstorne of [Confidential Computing](/learn/confidential-computing/overview) and a key concept behind Klave are the secure hardware enclaves. Actually the name Klave comes from the word enclave (on-klave, enclave, get it?).
