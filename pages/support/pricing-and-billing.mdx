...
<Callout emoji="🎉">
  Currently, all queries are free on Klave. Enjoy it while it lasts. [See here](../concepts/ledger-query-transaction.md) to learn more about Query and Transaction.
</Callout>
