...
import WhitepaperButtons from '@/components/whitepaper-buttons.tsx'

## Klave Whitepaper

*Introductory paper on Klave that is meant to evolve over time.
To learn about the latest developments of Klave, and how to's for developers we recommend the [documentation](/docs).*
