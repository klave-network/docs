  ...
  return (
    <div className="flex flex-col gap-8 items-center justify-center text-center">
      <div className="grid grid-cols-1 sm:grid-cols-2 sm:grid-rows-3 gap-4 md:gap-8">
        <div
          className="bg-cta-gradient sm:col-span-2 sm:row-span-2 flex flex-col gap-4 justify-center rounded-lg border border-fd-primary/30 bg-transparent p-4 md:p-6 shadow-md"
        >
        ...
        {blocks.map((block) => (
          <Link
            key={block.title}
            href={block.link}
            className="no-underline flex flex-col rounded-lg border border-fd-primary/30 bg-fd-card p-4 md:p-6 shadow-md transition-all hover:border-fd-primary hover:bg-fd-primary/20"
          >
            <div className="flex justify-between items-center">
...
const blocks = [
  ...
  {
    title: 'Newsletter',
    description: 'Get short, sweet and brief product updates, company news, and more.',
