...
import { Globe, AppWindowMac, ArrowRight } from 'lucide-react';
...
export const baseOptions: BaseLayoutProps = {
  ...
  links: [
    ...
    {
      text: 'Templates',
      url: 'https://klave.com/marketplace',
      external: true
    },
    {
      type: 'icon',
    ...
    tabs: {
      transform(option, node) {
        ...
        return {
          ...
          icon: (
            <div
              className="rounded-md border mb-auto bg-linear-to-t from-fd-background/80 p-1 [&_svg]:size-5"
              style={{
