...
const toggleOptions: ToggleOption[] = [
	{
		...
		url: '/sdk/latest',
		icon: Library,
		color: 'bg-linear-to-b from-muted/50 to-primary/60 text-klave-strong-blue dark:to-secondary/60 dark:text-klave-blue'
	},
	{
		title: 'Connector',
		...
		url: '/sdk/v0.0.1',
		icon: PlugZap,
		color: 'bg-linear-to-b from-muted/50 to-accent/60 text-klave-strong-teal dark:to-primary/60 dark:text-klave-teal'
	}
];
...
export const SidebarBanner = () => {
	...
	const showToggle = pathname.includes('sdk') || pathname.includes('connector');
